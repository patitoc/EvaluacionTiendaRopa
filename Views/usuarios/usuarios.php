            ...
            <form method="post" id="form_usuarios">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" required class="form-control" id="Nombres" name="Nombres" placeholder="Jhon">
                    </div>
                    <div class="form-group mt-2">
                        <label for="Apellidos">Apellidos</label>
                        <input type="text" required class="form-control" id="Apellidos" name="Apellidos" placeholder="Doe">
                    </div>
                    <div class="form-group mt-2">
                        <label for="Telefono">Teléfono</label>
                        <input type="text" required class="form-control" id="Telefono" name="Telefono" placeholder="0987654321">
                    </div>
                    <div class="form-group mt-2">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" required onfocusout="verifica_correo()" class="form-control" id="Correo" name="Correo" placeholder="email@gmail.com">
                        <div class="alert alert-danger d-none" role="alert" id="CorreoRepetido">
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <label for="Contrasenia">Contraseña</label>
                        <input type="password" required onfocusout="verifica_contrasenias()" class="form-control" id="Contrasenia" name="Contrasenia" placeholder="**********">
                        <div class="alert alert-danger d-none" role="alert" id="errorContrasenia">
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <label for="nombre">Repita su contraseña</label>
                        <input type="password" required class="form-control" onfocusout="verifica_contrasenias()"  id="Contrasenia2" placeholder="**********">
                        <div class="alert alert-danger d-none" role="alert" id="errorContrasenia">
                        </div>
                    </div>
